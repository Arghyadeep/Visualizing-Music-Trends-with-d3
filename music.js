...
d3.queue()
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/01.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/02.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/03.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/04.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/05.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/06.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/07.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/08.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/09.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/10.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/11.csv")
    .defer(d3.csv, "https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/12.csv")
   ...
   // console.log(arr);
    ...
    d3.json("https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/countries.geo.json", function(error, data) {

        d3.csv("https://arghyadeep.github.io/Visualizing-Music-Trends-with-d3/idCountry.csv", function(error, csv) {
